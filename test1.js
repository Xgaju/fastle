...
function generateHeaders(url, streamId, type, statuses, version) {
    ...
    const userAgents = [
        ...
        'Mozilla/5.0 (Linux; Android 13; SM-S901U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.6167.160 Mobile Safari/537.36',
        ...
        'Mozilla/5.0 (iPad; CPU OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/121.0.6167.124 Mobile/15E148 Safari/604.1'
    ];
